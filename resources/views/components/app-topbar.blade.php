...
<header class="sticky top-0 z-30 flex h-14 shrink-0 items-center gap-3 border-b border-gray-200 bg-white/95 px-4 backdrop-blur dark:border-gray-700 dark:bg-gray-800/95">
    <button type="button" @click="openMobile()"
            class="inline-flex min-h-11 min-w-11 items-center justify-center rounded-md p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700 sm:min-h-0 sm:min-w-0 lg:hidden dark:text-gray-400 dark:hover:bg-gray-700"
            aria-label="メニューを開く"
    ...
    @if ($user)
        <div class="ms-auto">
            <x-dropdown align="right" width="48">
                <x-slot name="trigger">
                    <button type="button"
                            class="inline-flex min-h-11 items-center gap-2 rounded-md px-3 py-2 text-sm font-medium text-gray-600 transition hover:bg-gray-100 hover:text-gray-800 motion-reduce:transition-none sm:min-h-0 dark:text-gray-300 dark:hover:bg-gray-700">
